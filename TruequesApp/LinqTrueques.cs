...
namespace TruequesApp
{
    internal class LinqTrueques
    {
        ...
        #region Rutas
        static string rutaProductos = @"C:\Users\barri\source\repos\TruequesApp\TruequesApp\bin\Debug\Productos.txt";
        static string rutaClientes = @"C:\Users\barri\source\repos\TruequesApp\TruequesApp\bin\Debug\Clientes.txt";
        static string rutaOperaciones = @"C:\Users\barri\source\repos\TruequesApp\TruequesApp\bin\Debug\Productos.txt";
        #endregion
        ...
        public static void ConteoGeneral()
        {
            ...
            Console.WriteLine(
                ...
                "Operaciones Realizadas:" + k + Environment.NewLine);
        }
        ...
        #region RellenarListas
        public static void RellenarListaCLientes()
        {
            string[] linea;
            listaClientes = new List<Cliente>();

            using (StreamReader sr = new StreamReader(rutaClientes))
            {
                try
                {
                ...
                {
                    Console.WriteLine("No hay clientes en lista.");
                }
                sr.Dispose();
                sr.Close();
            }
        ...
        public static void RellenarListaOperaciones()
        {
            ...
            using (StreamReader sr = new StreamReader(rutaOperaciones))
            {
                try
                { //si no es el final del stream, loop
                    while (!sr.EndOfStream)
                    {
                        ...
                        //se ingresan los valores leidos del string a cada parametro del nuevo cliente, en la lista.
                        listaOperaciones.Add(new Operacion(idOperacion, fechaOperacion, tipoOperacion, idCliente, idProducto));
                    }
                }
                catch
                {
        ...
        public static void RellenarListaProductos()
        {
            ...
            using (StreamReader sr = new StreamReader(rutaProductos))
            {
                try
                {
                    while (!sr.EndOfStream)
                    {
                        ...
                        listaProductos.Add(new Producto(int.Parse(linea[0]), linea[1], DateTime.Parse(linea[2]), linea[3], int.Parse(linea[4]), prefe, Convert.ToBoolean(linea[6])));
                    }
                }
                catch
                {
                    Console.WriteLine("No hay productos en lista.");
                }
                sr.Dispose();
                sr.Close();
            }
        ...
        public static void AgregarCliente()
        {
            ...
            do
            {//La misma idea que el anterior, se verifica que sea un número y que sea de largo 9
            ...
            if (busqueda.Count() == 0)
            {
                ...
                LinqTrueques.insertarTxtCliente();
                LinqTrueques.GuardarOperacion(fecha, 2, strRut, 0);
        ...
        internal static void ModificarDisponible()
        {
            ...
            try
            {
                if (int.TryParse(codigoElegido, out int opc) || opc < listadoProductos.Count() && opc != 0)
                {
                    ...
                    LinqTrueques.GuardarOperacion(fechaModificacion, 3, listaProductos[i].ClienteId, listaProductos[i].CodigoProducto);
                }
            }
            catch (Exception ex)
            {
        ...
        public static void AgregarProducto()
        {
            ...
            do
            {
                ...
                if (busquedaCodigo.Count() == 0)
                {
                    ...
                    insertarTxtProducto();
                    LinqTrueques.GuardarOperacion(fecha, 1, idCliente, codigo);
        ...
        public static void GuardarOperacion(DateTime fecha, int tipo, string nCliente, int nProducto)
        {
            ...
            do
            {
                ...
                if (filtroOperaciones.Count() == 0)
                {
                    ...
                    LinqTrueques.insertarTxtOperacion();
                    valido = true;
                }
                i++;
            } while (!valido);
        ...
        public static void ProductosDisponibles()
        {
            ...
            IEnumerable<Producto> estadoDisponible = from Producto in listaProductos where Producto.Disponible.Equals(true) select Producto;
        ...
        public static void ProductosNoDisponibles()
        {
            ...
            IEnumerable<Producto> estadoNoDisponible = from Producto in listaProductos where Producto.Disponible == false select Producto;
        ...
        public static void insertarTxtOperacion()
        {
            string texto = "";
            //Insertará texto en base solo a lo listado
            using (StreamWriter sw = new StreamWriter(rutaOperaciones))
            {
                try
                {
                    string o = "";
